...
def get_default_config():
    ...
    cfg.generation.max_length = 1024  # the max_length of the generated sentence. INCLUDING the input_ids. So: generation.max_length > dataloader.max_seq_length
    ...
    cfg.prefix_tuning_template.mid_dim = 1024
