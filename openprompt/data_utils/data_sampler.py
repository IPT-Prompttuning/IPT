...
class FewShotSampler(object):
    ...
    def __call__(self, 
        ...
        if valid_dataset is None:
            ...
            train_dataset_all = self._sample(train_dataset, seed)
            if self.also_sample_dev:
                valid_dataset = self._sample(valid_dataset, seed)
            train_dataset = train_dataset_all[:self.num_examples_per_label_dev]
            valid_dataset = train_dataset_all[self.num_examples_per_label_dev:]
